...
\item 
\mbox{\hyperlink{classPIDController_a805965a8d2277c261c8d0f9e23c7e6a3}{PIDPosition\+Controller}} (\mbox{\hyperlink{classBaseMotor}{Base\+Motor}} $\ast$m, float frequency=50)
\item 
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{classPIDController_a805965a8d2277c261c8d0f9e23c7e6a3}\label{classPIDController_a805965a8d2277c261c8d0f9e23c7e6a3}} 
\index{PIDController@{PIDController}!PIDPositionController@{PIDPositionController}}
\index{PIDPositionController@{PIDPositionController}!PIDController@{PIDController}}
\doxysubsubsection{\texorpdfstring{PIDPositionController()}{PIDPositionController()}}
{\footnotesize\ttfamily PIDController\+::\+PIDPosition\+Controller (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classBaseMotor}{Base\+Motor}} $\ast$}]{m,  }\item[{float}]{frequency = {\ttfamily 50} }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}

Construct the PIDPosition\+Controller 
\begin{DoxyParams}{Parameters}
